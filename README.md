# AssessRight: Interactive Online Assessment Engine
...
* **Performance Tracking**: Parent and Principal portals for monitoring student progress and class-wide trends.

## 🛠️ Technical Stack
* **Backend**: Python 3.8+, Django 4.x/5.x
...
1. **Clone the repository**:
   `git clone https://github.com/Vijay677-ctrl/quiz_app.git`
...
## 📊 Conclusion
AssessRight demonstrates how automation reduces administrative overhead and human error while providing immediate, quantifiable feedback to learners. It fosters academic excellence by promoting transparency and data-driven decision-making within educational institutions.
